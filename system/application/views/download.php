<div class="section">
    ...
    href="http://doc.manasource.org/client_installation">installation
    instructions</a>.

    <p><i><a href="http://manasource.org/files/mana-0.6.1-shortlog.txt">Changes in 0.6.1</a></i></p>

    <h3>Mana client 0.6.0</h3>

    <ul>
    <li><p>Source: <a href="http://manasource.org/files/mana-0.6.0.tar.gz">mana-0.6.0.tar.gz</a> (4.5 MB)</p></li>
    <li><p>Windows: <a href="http://manasource.org/files/mana-0.6.0-win32.exe">mana-0.6.0-win32.exe</a> (5.8 MB)</p></li>
    </ul>
    ...
    <ul>
    <li><p>Source: <a href="http://manasource.org/files/mana-0.5.3.tar.gz">mana-0.5.3.tar.gz</a> (2.4 MB)</p></li>
    <li><p>Windows: <a href="http://manasource.org/files/mana-0.5.3-win32.exe">mana-0.5.3-win32.exe</a> (5.5 MB)</p></li>
    </ul>
    ...
    <p><i><a href="http://manasource.org/files/mana-0.5.1-shortlog.txt">Changes in 0.5.1</a></i></p>

    <h3>Nightlies for Windows</h3>

    <p>If you want to use the bleeding edge, but compiling is difficult on your system, you may want to try our <a href="http://nightlies.manasource.org">nightly builds for Windows</a>.</p>
